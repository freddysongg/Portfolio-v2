        ...
        return (
          ...
          i
            ...
            .then((r) => {
              ...
              ).then((t) => eu({ ...e, err: s, Component: u, styleSheets: l, props: t }));
            })
        );
      }
      function Z(e) {
      ...
      class z {
        ...
        async change(e, t, r, n, o) {
          ...
          try {
            ...
            if (
              ...
              !(B && !g && !q && !Z && (0, A.compareRouterStates)(y, this.state)))
            ) {
              try {
                await this.set(y, a, g);
              } catch (e) {
        ...
        async handleRouteInfoError(e, t, r, n, o, a) {
          ...
          if ((0, i.isAssetError)(e) || a)
            throw (z.events.emit('routeChangeError', e, n, o), X({ url: n, router: this }), L());
          console.error(e);
          try {
            let n;
